...
DATASETS_CONFIG = {
    "Colonoscopic":
        {
        'root': '/gaoxieping/dsh/data/pretrain/Colonoscopic/',
        'setting': '/gaoxieping/dsh/data/pretrain/Colonoscopic/train_list.txt',
        'prefix': '/gaoxieping/dsh/data/pretrain/Colonoscopic/',
        },
    "LDPolypVideo": 
        {
        'root': '/gaoxieping/dsh/data/pretrain/LDPolypVideo/',
        'setting': '/gaoxieping/dsh/data/pretrain/LDPolypVideo/train_list.txt',
        'prefix': '/gaoxieping/dsh/data/pretrain/LDPolypVideo/',
        },
    "Hyper-Kvasir":
        {
        'root': '/gaoxieping/dsh/data/pretrain/Hyper-Kvasir/',
        'setting': '/gaoxieping/dsh/data/pretrain/Hyper-Kvasir/train_list.txt',
        'prefix': '/gaoxieping/dsh/data/pretrain/Hyper-Kvasir/',
        },
    "Kvasir-Capsule":
        {
        'root': '/gaoxieping/dsh/data/pretrain/Kvasir-Capsule/',
        'setting': '/gaoxieping/dsh/data/pretrain/Kvasir-Capsule/train_list.txt',
        'prefix': '/gaoxieping/dsh/data/pretrain/Kvasir-Capsule/',
        },
    "CholecT45": 
        {
        'root': '/gaoxieping/dsh/data/pretrain/CholecT45/',
        'setting': '/gaoxieping/dsh/data/pretrain/CholecT45/train_list.txt',
        'prefix': '/gaoxieping/dsh/data/pretrain/CholecT45/',
        },
    "EndoFM":
        {
        'root': '/gaoxieping/dsh/data/pretrain/private/',
        'setting': '/gaoxieping/dsh/data/pretrain/private/train_list.txt',
        'prefix': '/gaoxieping/dsh/data/pretrain/private/',
        },
    "SUN-SEG":
        {
        'root': '/gaoxieping/dsh/data/pretrain/SUN-SEG/',
        'setting': '/gaoxieping/dsh/data/pretrain/SUN-SEG/train_list.txt',
        'prefix': '/gaoxieping/dsh/data/pretrain/SUN-SEG/',
        },
    "GLENDAv1":
        {
...
class DataAugmentationForVideoMAE(object):
    def __init__(self, args):
        ...
        elif args.mask_type in 'learnable':
...
def build_pretraining_pcf_dataset(args):
    ...
    for dataset_name in args.mix_datasets:
        ...
        dataset = VideoMAE(
            ...
            pcf_sample=True,
            pcf_total_frames=args.pcf_total_frames,
            pcf_each=args.num_frames,
        )
