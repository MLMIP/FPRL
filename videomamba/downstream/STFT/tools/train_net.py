...
from stft_core.utils.dist_env import init_dist, init_distributed_mode
...
def train(cfg, local_rank, distributed, logger, tb_writer):
    ...
    optimizer = torch.optim.AdamW(model.parameters(), lr=cfg.SOLVER.BASE_LR, weight_decay=5e-4)
