...
def get_parser():
    ...
    # general config
    parser.add_argument('--method', type=str, default='fcrmamba_small_b64_seqlen2withRatio09__withteacher_MIX7')
    parser.add_argument('--datadir', type=str, default='/gaoxieping/dsh/data/downstream/KUMC/processed/val2019/Image')
...
if __name__ == '__main__':
    ...
    saved = '/gaoxieping/dsh/FCRMamba/videomamba/out/Detection'
