...
def cvcvideo_detection_eval(pred_boxlists, gt_boxlists, score_thrs):
    ...
    detection_tp = np.zeros((len(pred_boxlists), score_thrs.shape[0]), dtype=int)
    detection_fp = np.zeros((len(pred_boxlists), score_thrs.shape[0]), dtype=int)
    detection_tn = np.zeros((len(pred_boxlists), score_thrs.shape[0]), dtype=int)
    detection_fn = np.zeros((len(pred_boxlists), score_thrs.shape[0]), dtype=int)
    pos_num=0
    neg_num=0
